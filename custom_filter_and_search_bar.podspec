#
#  Be sure to run `pod spec lint custom_filter_and_search_bar.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "custom_filter_and_search_bar"
  spec.version      = "1.0.0"
  spec.summary      = "The library allows users to create a customised search bar with an inbuilt filter functionality."
...
- Search bar can be customised as per requirement
  ...
  spec.homepage     = "https://github.com/softsuave-tech-matrix/custom_filter_and_search_bar.git"
  ...
  spec.source       = { :git => "https://github.com/softsuave-tech-matrix/custom_filter_and_search_bar.git", :tag => "1.0.0" }
